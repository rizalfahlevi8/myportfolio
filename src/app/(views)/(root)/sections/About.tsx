            ...
            <div className="container">
                ...
                <div className="mt-20 flex flex-col gap-8 mx-10 md:mx-10 lg:mx-30 xl:mx-60">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
                        <Card className="md:col-span-2 lg:col-span-1 h-80 relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
                        <Card className="h-80 md:col-span-3 lg:col-span-2 overflow-hidden">
                            ...
                            <ToolboxItems items={home.Skills} className="" itemsWrapperClassName="animate-move-left [animation-duration:100s]" />
                            <ToolboxItems items={home.Skills} className="mt-6" itemsWrapperClassName="animate-move-right [animation-duration:50s]" />
                        </Card>
                        ...
                        <TooltipProvider>
                            <Tooltip open={showTooltip} onOpenChange={setShowTooltip}>
                                <TooltipTrigger asChild>
                                    <Card 
                                        className="h-80 p-0 relative md:col-span-2 lg:col-span-1 cursor-pointer hover:scale-105 transition-transform duration-300"
                                    ...
                                    >
                                        ...
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full bg-linear-to-r from-gray-300 to-gray-500 after:content-[''] after:absolute after:inset-0 after:outline after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
                                            <div className="absolute inset-0 rounded-full bg-linear-to-r from-gray-300 to-gray-500 -z-20 animate-ping animation-duration-[2s]"></div>
                                            <div className="absolute inset-0 rounded-full bg-linear-to-r from-gray-300 to-gray-500 -z-10"></div>
