            ...
            <div className="container">
                                                ...
                                                <div className={`space-y-3 transition-all duration-500 ${visibleItems.has(workIndex)
                                                    ...
                                                    <ul className="space-y-2">
                                                        {work.description.map((desc, descIndex) => (
                                                            ...
                                                            >
                                                                <ChevronRight size={14} className="text-primary mt-0.5 shrink-0 transition-transform duration-300 group-hover/item:translate-x-1" />
                                                                <span>{desc}</span>
                                                            </li>
                                                        ))}
                                                    </ul>
                ...
                <div className="flex justify-center mt-12">
                    ...
                    >
                        ...
                        <span className="relative z-5 transition-transform duration-300 group-hover:scale-105">
                            View All Work Experience
                        </span>
                        <ArrowUpRightIcon className="relative z-5 w-4 h-4 transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1" />
                    </Link>
                </div>
            </div>
        </section>
